    ...
    public class SignFormsController : Controller
    {
        ...
        public ActionResult Index(int? eid)
        {
            if (eid != null) {
                ...
                ViewBag.parentName = eventPage.name;
                return View(eventPage.SignForm.OrderByDescending(o => o.sId).ToList());
            }
            return HttpNotFound();
        }
        ...
        public ActionResult Create([Bind(Include = "sId,eId,userLimit,dateStart,dateEnd,field,isEnable")] SignForm signForm)
        {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.parentName = signForm.EventPage.name;
            return View(signForm);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "sId,eId,userLimit,dateStart,dateEnd,field,isEnable")] SignForm signForm)
        {
            if (ModelState.IsValid)
            {
                signForm.field = formatpotoString();
        ...
        public string getSignNum(int sId)
        {
            return "<p>報名人數:"+db.SignForm.Find(sId).SignRecords.Count+"</p>";

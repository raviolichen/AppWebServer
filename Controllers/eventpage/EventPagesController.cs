...
namespace AppWebServer.Controllers
{
    ...
    public class EventPagesController : Controller
    {
        ...
        {
            return View(db.EventPage.OrderByDescending(o => o.eid).ToList());
        }
        ...
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "eid,url,name,html,dateStart,dateEnd,slvLimit,toGoldNum,evenType")] EventPage eventPage)
        {
